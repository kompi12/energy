...
public class ApartmentUpsertService {
     ...
     */
    @Transactional
    public Apartment findOrCreateApartment(
            String mbr,
            String addressLine,
            String cityName,
            String meterCode,
        ...
        Optional<Apartment> existingApartment = apartmentRepository.findByMbr(mbr);
        if (existingApartment.isPresent() ) return existingApartment.get();
